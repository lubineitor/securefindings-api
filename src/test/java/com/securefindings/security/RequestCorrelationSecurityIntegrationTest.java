...
class RequestCorrelationSecurityIntegrationTest {
    ...
    @Test
    void deberiaIncluirElIdentificadorEnUnaRespuesta401()
            throws Exception {
    ...
    @Test
    void deberiaConservarUnIdentificadorValido()
            throws Exception {
    ...
    @Test
    void deberiaIncluirElIdentificadorEnElHealthCheck()
            throws Exception {
